...
export const CASHIER_FEATURES: Record<string, { label: string; default: boolean; group: string }> = {
  ...
  opname_apply: { label: 'Apply opname (potong selisih ke stok)', default: false, group: 'Operasional stok' },
...
// Returns an error message if denied, or null if allowed. Admin always allowed.
